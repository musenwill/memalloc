...
func main() {
	...
	app.Flags = []cli.Flag{maxLimitFlag, minSizeFlag, maxSizeFlag, spreadFlag,
		reMinSizeFlag, reMaxSizeFlag, reSpreadFlag, printFlag, halfFlag}
	app.Action = action
...
func action(c *cli.Context) error {
	a := alloc.NewAlloc(alloc.Config{
		...
		ReleaseHalf: c.GlobalBool(halfFlag.Name),
	})
	a.Run()
	return nil
}
